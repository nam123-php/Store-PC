...
class JobCreateOrderToGhn implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $template['from_name'] = "Thạch Ân";
        $template['from_phone'] = "0588940394";
        $template['from_address'] = "Lũy Bán Bích Quận Tân Phú TP Hồ Chí Minh";
        $template['from_ward_name'] = "Lũy Bán Bích";
        $template['from_district_name'] = "Tân Phú";
        $template['from_province_name'] = "Hồ Chí Minh";
