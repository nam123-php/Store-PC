...
<head>
    ...
    <title>@yield('title_page','Store PC Game')</title>
...
<div class="page-wrapper">
    ...
    <footer class="footer">
        <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url(/fe_v2/assets/images/demos/demo-4/bg-5.jpg);">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget widget-about">
                            <img src="/fe_v2/assets/images/demos/demo-4/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
        ...
        <div class="footer-bottom">
            <div class="container">
                <p class="footer-copyright">Copyright © 2024 Store PC. All Rights Reserved.</p><!-- End .footer-copyright -->
